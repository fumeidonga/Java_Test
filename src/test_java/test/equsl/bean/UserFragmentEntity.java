...
import test_java.test.equsl.TextUtils;
...
public class UserFragmentEntity {
    ...
    public boolean equals(Object obj) {
        ...
        if(obj.getClass() == UserFragmentEntity.class) {
            UserFragmentEntity compar = (UserFragmentEntity) obj;
            return compar.getCash().equals(cash) && compar.getCoin().equals(coin)
                    && compar.getToday_read_duration().equals(today_read_duration)
                    && compar.getUserEntrances().equals(userEntrances);
        }
    ...
    public static class Panel {
        ...
        public boolean equals(Object obj) {
            ...
            if(obj.getClass() == Panel.class) {
            	Panel compar = (Panel) obj;
                return compar.getList().equals(list);
            }
    ...
    public static class UserEntrances {
        ...
        public void setIs_button_click(boolean is_button_click) {
            this.is_button_click = is_button_click;
        }

        public String getButton_statistical_code() {
            return button_statistical_code;
        }

        public void setButton_statistical_code(String button_statistical_code) {
            this.button_statistical_code = button_statistical_code;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if(obj.getClass() == UserEntrances.class) {
                UserEntrances compar = (UserEntrances) obj;
                if(!TextUtils.isEmpty(link_url) && !TextUtils.isEmpty(show_type)
                        && !TextUtils.isEmpty(first_title)
                        && !TextUtils.isEmpty(icon_url) ){
                    return compar.getLink_url().equals(link_url) && compar.getShow_type().equals(show_type)
                            && compar.getFirst_title().equals(first_title)
                            && compar.getIcon_url().equals(icon_url) && compar.getItemType() == itemType;
                }
            }
